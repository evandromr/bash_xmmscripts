...
export mos1srclc="MOS1_lc_src_"$strrange"_timed.ds"
export mos1bkglc="MOS1_lc_bkg_"$strrange"_timed.ds"
export mos1netlc="MOS1_lc_net_"$strrange"_timed.ds"
export mos1srcimg="MOS1_src_img_"$strrange"_timed.ds"
export mos1bkgimg="MOS1_bkg_img_"$strrange"_timed.ds"
export psimg="MOS1_lc_net_"$strrange"_timed.ps"
