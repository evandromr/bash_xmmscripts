...
export mos2srclc="MOS2_lc_src_"$strrange"_timed.ds"
export mos2bkglc="MOS2_lc_bkg_"$strrange"_timed.ds"
export mos2netlc="MOS2_lc_net_"$strrange"_timed.ds"
export mos2srcimg="MOS2_src_img_"$strrange"_timed.ds"
export mos2bkgimg="MOS2_bkg_img_"$strrange"_timed.ds"
export psimg="MOS2_lc_net_"$strrange"_timed.ps"
