...
export pnsrclc="PN_lc_src_"$strrange".ds"
export pnbkglc="PN_lc_bkg_"$strrange".ds"
export pnnetlc="PN_lc_net_"$strrange".ds"
export pnsrcimg="PN_src_img_"$strrange".ds"
export pnbkgimg="PN_bkg_img_"$strrange".ds"
export psimg="PN_lc_net_"$strrange".ps"
